...
public:
  ...
  // [set_parameters]
  bool set_parameters(const VecX &x0_input, const Number T_input,
   ...
   */
  //@{
  ExcitingTrajectoryGenerator(const ExcitingTrajectoryGenerator &);

  ExcitingTrajectoryGenerator &operator=(const ExcitingTrajectoryGenerator &);
