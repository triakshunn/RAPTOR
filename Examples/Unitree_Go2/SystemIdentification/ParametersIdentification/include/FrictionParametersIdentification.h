...
public:
  ...
  // [set_parameters]
  bool set_parameters(const Model &model_input,
  ...
  bool get_bounds_info(Index n, Number *x_l, Number *x_u, Index m, Number *g_l,
                       Number *g_u) final override;

  /** Method to return the objective value */
  bool eval_f(Index n, const Number *x, bool new_x,
              Number &obj_value) final override;

  /** Method to return the gradient of the objective */
  bool eval_grad_f(Index n, const Number *x, bool new_x,
                   Number *grad_f) final override;

  /** Method to return:
   *   1) The structure of the hessian of the lagrangian (if "values" is NULL)
   *   2) The values of the hessian of the lagrangian (if "values" is not NULL)
   */
  bool eval_hess_f(Index n, const Number *x, bool new_x,
                   MatX &hess_f) final override;
   ...
   */
  //@{
  FrictionParametersIdentification(const FrictionParametersIdentification &);

  FrictionParametersIdentification &
  operator=(const FrictionParametersIdentification &);
