...
public:
  ...
  using nb_2d_double =
      nb::ndarray<double, nb::ndim<2>, nb::c_contig, nb::device::cpu>;
  ...
  // class methods
  void set_ipopt_parameters(const double tol, const double max_wall_time,
                            const int print_level, const int max_iter,
